...
document.addEventListener('DOMContentLoaded', function() {
    fetch('/api/config').then(r => r.json()).then(d => {
        ...
        const demoData = {
            ...
            WIFI_TX_POWER_DBM: 20, WIFI_SSID: """", WIFI_PASSWORD: "••••••••", WIFI_SSID_1: """", WIFI_PASSWORD_1: "••••••••",
            WIFI_SSID_2: """", WIFI_PASSWORD_2: "••••••••", WIFI_SSID_3: "", WIFI_PASSWORD_3: "", WIFI_SSID_4: "", WIFI_PASSWORD_4: "",
