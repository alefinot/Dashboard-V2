...
int BAR_TIMEOUT_MS = 7000;
bool BAR_SHOW_APP = true;
...
char OTA_CURRENT_VERSION[32] = "1.2.7";
...
void processConfig(int mode, JsonDocument *doc) {
  ...
  CFG_BOOL(BLE_ENABLED, "BLE_EN", true);
  CFG_BOOL(BAR_ENABLED, "BAR_EN", true);
  CFG_INT(BAR_TIMEOUT_MS, "BAR_TMO", 7000);
  CFG_BOOL(BAR_SHOW_APP, "BAR_SHOW_APP", true);
  ...
  CFG_STR(OTA_CURRENT_VERSION, "OTA_VER", "1.2.7");
